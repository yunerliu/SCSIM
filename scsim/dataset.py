...
class CsvDataset(DownloadableDataset):
    """Loads a `.csv` file.
    Hongming: by default the dataset loaded should be a gene(row) by cell(column) csv compressed as a .gz file
    ...
    Examples:
        ...
        ... save_path="data/", compression='gx,y=Variable(x, requires_grad=True),Variable(y)
zip')
    """
